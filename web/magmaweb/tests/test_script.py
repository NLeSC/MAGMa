...
class TestMagmaSubCommands(TestCase):
    ...
    def testAddUser(self):
        args = Namespace(user=u'someone', name=u'somename', email=u'someemail', password='secret')
    ...
    def testUpdateUser_changeDisplayname(self):
        self.command.add(Namespace(user=u'someone', name=u'somename', email=u'someemail', password='secret'))
