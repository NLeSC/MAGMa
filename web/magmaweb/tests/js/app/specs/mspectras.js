describe('MSpectras controller', function() {
  ...
  describe('loadMSpectra', function() {
    ...
    beforeEach(function() {
      ...
      spyOn(ctrl, 'getMSpectra').and.returnValue(mspectra);
  ...
  describe('onLoadMSpectra', function() {
    it('notfound', function() {
      ...
      expect(Ext.Error.handle).toHaveBeenCalledWith({
        ...
        sourceMethod: 'onLoadMSpectra',
        sourceClass: 'Esc.magmaweb.controller.MSpectras'
      });
    });
    ...
    describe('lvl 1 spectra', function() {
      ...
      beforeEach(function() {
        ...
        spyOn(mspectra, 'selectPeak').and.returnValue(true);
        spyOn(mspectra, 'up').and.callFake(function() {
          return {
            down: function() {
              return {
                enable: function() {
        ...
        callback = jasmine.createSpy('callback').and.returnValue(false); // listeners dont hear any events
  ...
  describe('loadMSpectraFromFragment', function() {
    it('already loaded', function() {
      ...
      spyOn(ctrl, 'getMSpectra').and.returnValue({
        scanid: scanid
      });
      spyOn(ctrl, 'loadMSpectra');
    ...
    it('new scan', function() {
      ...
      expect(ctrl.getMSpectra).toHaveBeenCalledWith(mslevel);
      expect(ctrl.loadMSpectra).toHaveBeenCalledWith(mslevel, scanid, [{
        mz: 123
      }], true);
    });
  });
  ...
  describe('clearMSpectra', function() {
    ...
    beforeEach(function() {
      ...
      spyOn(Ext, 'getCmp').and.returnValue(mspectrapanel);
  ...
  it('clearMSpectraFromFragment', function() {
    ...
    ctrl.clearMSpectraFromFragment({
      data: {
        mslevel: 2
      }
    });
