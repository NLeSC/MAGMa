...
Ext.onReady(function() {
  ...
  Application = Ext.create('Esc.magmaweb.resultsApp', {
      ...
      runInfoUrl: function() { return appRootBase + '/data/runinfo.json' },
      // use test files for metabolites in data/
      metabolitesUrl: function(format) {
          return appRootBase + '/data/metabolites.'+format;
      },
  ...
  Ext.getBody().createChild(
	  {tag:'div', id: 'resultsinfo', html:'placeholder for resultsinfo'}
  );
  Ext.getBody().createChild(
	  {tag:'div', id: 'logos',  html:'placeholder for logos'}
  );
