...
Ext.define('Esc.magmaweb.view.molecule.List', {
  ...
  getVisiblColumnIndices: function() {
    return this.getView().getHeaderCt().getVisibleGridColumns().map(function(v) {
      return v.dataIndex;
    }).filter(function(v) {
      return v;
    });
