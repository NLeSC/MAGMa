...
class MagmaCommand(object):
    ...
    def __init__(self):
        ...
        sc_add.add_argument('user', help="user id (default: %(default)s)", default=None,type=unicode)
        sc_add.add_argument('name', help="name (default: %(default)s)", default=None,type=unicode)
        sc_add.add_argument('email', help="e-mail address (default: %(default)s)", default=None,type=unicode)
        ...
        sc_update.add_argument('-u', '--user', help="change user id (default: %(default)s)", default=argparse.SUPPRESS,type=unicode)
        sc_update.add_argument('-n', '--name', help="change display name (default: %(default)s)", default=argparse.SUPPRESS,type=unicode)
        sc_update.add_argument('-e', '--email', help="change email (default: %(default)s)", default=argparse.SUPPRESS,type=unicode)
        sc_update.add_argument('-p', '--password', help="change password (default: %(default)s)", default=argparse.SUPPRESS,type=str)
        sc_update.add_argument('userid', help="user id (default: %(default)s)", default=None,type=unicode)
        ...
        sc_remove.add_argument('user', help="user id (default: %(default)s)", default=None,type=unicode)
        sc_remove.set_defaults(func=self.remove)

        sc_owner = sp.add_parser("owner", help=self.owner.__doc__, description=self.owner.__doc__)
        sc_owner.add_argument('job', help="job identifier", default=None, type=unicode)
        sc_owner.add_argument('user', help="user id", default=None,type=unicode)
        sc_owner.set_defaults(func=self.owner)

        sc_import = sp.add_parser("importjob", help=self.importjob.__doc__, description=self.importjob.__doc__)
        sc_import.add_argument('dbfile', help="job sqlite result db file", default=None, type=argparse.FileType('r'))
        sc_import.add_argument('owner', help="user id", default=None,type=unicode)
