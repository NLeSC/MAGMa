# -*- coding: utf-8 -*-
#
# MSygma documentation build configuration file, created by
...
latex_documents = [
  ('index', 'MSygma.tex', u'MSygma Documentation',
...
man_pages = [
    ('index', 'msygma', u'MSygma Documentation',
...
texinfo_documents = [
  ('index', 'MSygma', u'MSygma Documentation',
   u'Stefan Verhoeven & Lars Ridder', 'MSygma', 'One line description of project.',
   'Miscellaneous'),
]
