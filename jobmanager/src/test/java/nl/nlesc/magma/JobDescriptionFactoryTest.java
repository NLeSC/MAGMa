...
public class JobDescriptionFactoryTest extends TestCase {
	 ...
	 */
	@Test
	public void testGetJobDescriptionHostname()
			throws GATObjectCreationException {
	...
	public void testGetJobDescriptionWc() throws GATObjectCreationException,
		...
		JobSubmitRequest jobsubmission = new JobSubmitRequest(jobdir,
				"/bin/wc", args, prestage, poststage, "stderr.txt",
				"stdout.txt", new URI("http://example.com/status/1234.json"));
		...
		expected_poststage.put(GAT.createFile("nr.accounts"),
				GAT.createFile(jobdir + "nr.accounts"));
