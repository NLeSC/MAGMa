...
public class JobSubmitRequestTest {
	...
	public void testToString() {
		String s = "JobSubmitRequest [jobdir=/tmp/jobdir/, ";
		s += "executable=/bin/sh, stderr=stderr.txt, ";
		s += "stdout=stdout.txt, arguments=[magma.sh], ";
		s += "prestaged=[magma.sh, data.mzxml], poststaged=[results.db], ";
		s += "time_max=0, memory_min=0, memory_max=0, status_callback_url=http://localhost/status]";
