...
public class JobStateListenerTest {
	...
	public void testProcessMetricEvent() throws URISyntaxException,
		...
		// HttpPut.equals() fails when creating put object here, so capture it to verify
		...
		String content = CharStreams.toString(new InputStreamReader(r.getEntity().getContent()));
